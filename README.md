...
These limitations are useful rather than embarrassing — they expose, in closed form, exactly why a linear one-parameter drive cannot exceed $1/e$ fidelity against a Fock state, instead of artificially producing unrealistically high fidelities that wouldn't reflect anything about actual hardware constraints.
